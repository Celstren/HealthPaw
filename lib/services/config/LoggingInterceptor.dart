...
class LoggingInterceptors extends Interceptor {
  ...
  Future<dynamic> onError(DioError dioError) {
    ...
    print("Time taken: ${now.millisecondsSinceEpoch - start.millisecondsSinceEpoch} ms");
    print("${dioError.response != null && dioError.response.data != null ? dioError.response.data : dioError.error != null ? dioError.message :'Unknown Error'}");
    print("<-- End error");
