...
class PrevSetBreathing extends StatefulWidget {
  PrevSetBreathing({Key key}) : super(key: key);

  @override
  _PrevSetBreathingState createState() => _PrevSetBreathingState();
}

class _PrevSetBreathingState extends State<PrevSetBreathing> {
  @override
