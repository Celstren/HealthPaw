...
class SelectUserTypeContent extends StatefulWidget {
  ...
  SelectUserTypeContent({Key key, this.selectType = SelectType.Register}) : super(key: key);
        ...
        Expanded(
          ...
          children: <Widget>[
            CircularButton(
              ...
              onPress: () {
                if (widget.selectType == SelectType.Register) {
                  NavigationMethods.of(context).navigateTo(ManualRegisterView(userType: UserType.Vet));
                } else {
                  NavigationMethods.of(context).navigateTo(UserListView(userType: UserType.Vet));
                }
              },
            ...
            CircularButton(
              ...
              onPress: () {
                if (widget.selectType == SelectType.Register) {
                  NavigationMethods.of(context).navigateTo(ManualRegisterView(userType: UserType.Owner));
                } else {
                  NavigationMethods.of(context).navigateTo(UserListView(userType: UserType.Owner));
                }
              },
