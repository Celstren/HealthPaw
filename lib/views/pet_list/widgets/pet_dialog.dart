...
class _PetDialogState extends State<PetDialog> {
  ...
  void submit() async {
    bool noInternet = await GlobalDialogs.displayOnConnectionError;
    if (!noInternet) {
      Recommendation newRecommendation = Recommendation(
          description: controller.value.text, date: DateTime.now());
        ...
        children: <Widget>[
          Text(
            ...
            style: AppTextStyle.blackStyle(
                fontSize: AppFontSizes.title24, fontWeight: FontWeight.w700),
          ...
          RoundedButton(
            ...
            style: AppTextStyle.whiteStyle(
                fontSize: AppFontSizes.text12, fontWeight: FontWeight.w500),
            onPress: () {
              setState(() {
            ...
            child: TextField(
              ...
              onChanged: (value) {
                ...
                if (controller.value.text != null &&
                    controller.value.text.trim().isNotEmpty) {
                  isValid = true;
                } else {
                  isValid = false;
                }
